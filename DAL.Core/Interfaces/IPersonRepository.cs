...
namespace DAL.Core.Interfaces
{
	public interface IPersonRepository
	{
		...
		Task<IEnumerable<PersonEntity>> GetPersonListByPage(Guid personUid, int pageNumber, int pageSize, string query = null, CancellationToken cancellationToken = default);
